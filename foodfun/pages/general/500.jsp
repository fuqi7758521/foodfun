...
<link href="<%=request.getContextPath() %>/pages/general/assets/css/pages/error.css"   rel="stylesheet" type="text/css"/>
...
<div class="page-inner">
	<img src="<%=request.getContextPath() %>/pages/general/assets/img/earth.jpg"   class="img-responsive" alt="">
</div>
