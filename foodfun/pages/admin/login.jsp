...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/pages/admin/assets/plugins/select2/select2.css"/>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/pages/admin/assets/plugins/select2/select2-metronic.css"  />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/pages/admin/assets/plugins/bootstrap-toastr/toastr.min.css"  />
...
<link href="<%=request.getContextPath() %>/pages/admin/assets/css/pages/login-soft.css" rel="stylesheet" type="text/css"/>
<link href="<%=request.getContextPath() %>/pages/admin/assets/css/custom.css" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
<link href="<%=request.getContextPath() %>/pages/admin/assets/img/favicon1.ico" rel="SHORTCUT ICON" type="image/ico">
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="login">
...
<div class="logo">
	<a href="<%=request.getContextPath() %>/index.html" >
		<img src="<%=request.getContextPath() %>/pages/admin/assets/img/logo.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<%=request.getContextPath() %>/admin/doLogin.html" method="post">
...
<script src="<%=request.getContextPath() %>/pages/admin/assets/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
<script src="<%=request.getContextPath() %>/pages/admin/assets/plugins/select2/select2.min.js" type="text/javascript"></script>
...
<script src="<%=request.getContextPath() %>/pages/admin/assets/scripts/custom/login-soft.js" type="text/javascript"></script>
