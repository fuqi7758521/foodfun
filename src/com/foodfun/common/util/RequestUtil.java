...
public class RequestUtil {
    ...
    public static void setTableShowType(HttpServletRequest request){
    	request.setAttribute("showType", new String[]{"active","success","warning","danger"});
    }
    
   public static void main(String[] args) throws Exception {
	   Date deadlineDate = DateUtil.toDate(DateUtil.formatDateTime(new Date(), DateUtil.LONG_DATE_FORMAT) + " 11:00:00", DateUtil.FORMAT_ONE);
   	if(DateUtil.dayDiff(deadlineDate, new Date()) > 0){
